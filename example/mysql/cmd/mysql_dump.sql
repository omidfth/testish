...
CREATE TABLE `test_models` (
  ...
  `name` longtext,
  PRIMARY KEY (`id`),
  KEY `idx_test_models_deleted_at` (`deleted_at`)
...
INSERT INTO `test_models` VALUES (1,NULL,NULL,NULL,'omid'),(2,NULL,NULL,NULL,'ali');
...
-- Dump completed on 2024-04-03 18:45:03
